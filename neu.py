...
# NN
class MLP(nn.Module):
    def __init__(self, input_size = 10707, hidden_size=1000, output_size=2, weight_variance=None, activation='relu',
...
plot_stable_ranks_and_test_errors_from_runs(all_rank_records, all_test_error_records, 'neu_stable_ranks_and_test_errors_relu.png')
...
# Save the records
save_records(all_rank_records, all_test_error_records, 'neu_rank_records_relu.pickle', 'neu_test_error_records_relu.pickle')
