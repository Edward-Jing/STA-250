...
# NN
class MLP(nn.Module):
    def __init__(self, input_size=5, hidden_size=128, output_size=2, weight_variance=None, activation='leaky_relu',
...
plot_stable_ranks_and_test_errors_from_runs(all_rank_records, all_test_error_records, 'autism_stable_ranks_and_test_errors_leaky_relu.png')
...
# Save the records
save_records(all_rank_records, all_test_error_records, 'autism_rank_records_leaky_relu.pickle', 'autism_test_error_records_leaky_relu.pickle')
