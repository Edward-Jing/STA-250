...
class MLP(nn.Module):
    def __init__(self, input_size=28 * 28, hidden_size=1000, output_size=10, weight_variance=None, activation='relu',
...
plot_stable_ranks_and_test_errors_from_runs(all_rank_records, all_test_error_records, 'stable_ranks_and_test_errors_leaky.png')
...
# Save the records
save_records(all_rank_records, all_test_error_records, 'rank_records.pickle_leaky', 'test_error_records.pickle_leaky')
