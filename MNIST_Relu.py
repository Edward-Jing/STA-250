...
plot_stable_ranks_and_test_errors_from_runs(all_rank_records, all_test_error_records, 'stable_ranks_and_test_errors.png')
...
# Save the records
save_records(all_rank_records, all_test_error_records, 'rank_records.pickle', 'test_error_records.pickle')
